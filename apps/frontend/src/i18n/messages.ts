...
export const messages = {
  ...
  'landing.navDebrief': { en: 'The report', id: 'Laporan sesi' },
  'landing.navTechnology': { en: 'Technology', id: 'Teknologi' },
  'landing.openMenu': { en: 'Open menu', id: 'Buka menu' },
  'landing.closeMenu': { en: 'Close menu', id: 'Tutup menu' },
